...
export default function List() {
  const data = [{"base":"ant","firstLine":"ant.sh: Download and install Apache Ant"},{"base":"docker","firstLine":"docker.sh: Install the Docker Engine on Linux in a safe, idempotent, shell-friendly way"},{"base":"java-corretto","firstLine":"java-corretto.sh: Download and install Amazon Corretto OpenJDK"},{"base":"java-oracle","firstLine":"java-oracle.sh: Download and install Oracle JDK"},{"base":"java-temurin","firstLine":"java-temurin.sh: Download and install Eclipse Temurin Java (OpenJDK)"},{"base":"load","firstLine":"load.sh: Fetch a script from https://shellscript.download, cache it locally,"},{"base":"maven","firstLine":"maven.sh: Download and install Apache Maven"},{"base":"node-docker","firstLine":"node-docker.sh: Create Docker-backed Node.js launchers (node, npm, npx, yarn)"},{"base":"nvm","firstLine":"nvm.sh: Install Node Version Manager (NVM) and set up a shell init snippet"},{"base":"php-docker","firstLine":"php-docker.sh: Create Docker-backed php and composer launchers"},{"base":"php-rest-api","firstLine":"php-rest-api.sh: Install byjg/rest-reference-architecture in unattended mode"},{"base":"qemu","firstLine":"qemu.sh: Download QEMU and manage local virtual machines (start, list, stop, remove)"},{"base":"remove","firstLine":"remove.sh: Remove installed tools from shellscript.download"},{"base":"ssh-agent","firstLine":"ssh-agent.sh: Configure ssh-agent startup and SSH key loading in your shell"}] as { base: string; firstLine: string }[];
